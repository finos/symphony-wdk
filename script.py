...
for i in range(NB_WORKFLOWS_DEPLOYED):
    workflow_id = "simulation-workflow-" + str(i)
...
outputs_csv_filename = "states/states_" + str(NB_WORKFLOWS_DEPLOYED) + "_" + str(NB_PROCESSES_PER_WORKFLOW) + "_" + str(NB_ACTIVITIES_PER_WORKFLOW) + ".csv"
...
outputs_csv_filename = "duration/duration_" + str(NB_WORKFLOWS_DEPLOYED) + "_" + str(NB_PROCESSES_PER_WORKFLOW) + "_" + str(NB_ACTIVITIES_PER_WORKFLOW) + ".csv"
